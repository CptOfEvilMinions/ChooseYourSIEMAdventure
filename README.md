...
* [Github - dockerfiles/kibana/Dockerfile](https://github.com/elastic/dockerfiles/blob/7.10/kibana/Dockerfile)
...
* [elasticsearch-users](https://www.elastic.co/guide/en/elasticsearch/reference/current/users-command.html#users-command)
* [How to set passwords for built-in users in batch mode?](https://discuss.elastic.co/t/how-to-set-passwords-for-built-in-users-in-batch-mode/119655/5)
* [elasticsearch-keystore](https://www.elastic.co/guide/en/elasticsearch/reference/current/elasticsearch-keystore.html)
* [Kibana Keystore](https://discuss.elastic.co/t/kibana-keystore/132721/2)
* [Kibana keystore - Secure settings](https://www.elastic.co/guide/en/kibana/current/secure-settings.html)
* [elasticsearch-setup-passwords](https://www.elastic.co/guide/en/elasticsearch/reference/current/setup-passwords.html)
* [Logstash - Secrets keystore for secure settings](https://www.elastic.co/guide/en/logstash/current/keystore.html)
* [Elasticseach - Create passwords for built-in users](https://www.elastic.co/guide/en/elasticsearch/reference/7.x/get-started-built-in-users.html)
* [Elasticsearch - elasticsearch-setup-passwords](https://www.elastic.co/guide/en/elasticsearch/reference/current/setup-passwords.html)
* [Elasticsearch - elasticsearch-keystore](https://www.elastic.co/guide/en/elasticsearch/reference/current/elasticsearch-keystore.html)
* [Logstash - Configuring Logstash for Docker](https://www.elastic.co/guide/en/logstash/current/docker-config.html)
