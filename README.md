...
* [Github - splunk/TA-osquery](https://github.com/splunk/TA-osquery)
* [Splunk Add-On for Microsoft Sysmon](https://splunkbase.splunk.com/app/1914/)
* [How to use custom index for Universal Forwarder](https://community.splunk.com/t5/Getting-Data-In/How-to-use-custom-index-for-Universal-Forwarder/m-p/65512)
* [How to install Splunk Forwarder on Ubuntu](https://bobcares.com/blog/install-splunk-forwarder-on-ubuntu/)
* [How to Run MSI in Silent Mode](https://smallbusiness.chron.com/run-msi-silent-mode-50962.html)
* [How to restart windows universal forwarder?](https://community.splunk.com/t5/Getting-Data-In/How-to-restart-windows-universal-forwarder/m-p/61144)
* [How can I install Splunk universal forwarder on Windows?](https://answers.uillinois.edu/89805)
* [Install a Windows universal forwarder from the command line](https://docs.splunk.com/Documentation/Forwarder/8.1.2/Forwarder/InstallaWindowsuniversalforwarderfromthecommandline)
...
* [How to set the preferred network interface in linux](https://serverfault.com/questions/123553/how-to-set-the-preferred-network-interface-in-linux/836708)
...
* [How to do HTTP address health check in Splunk?](https://community.splunk.com/t5/Dashboards-Visualizations/How-to-do-HTTP-address-health-check-in-Splunk/m-p/219469)
* [HTTP Event Collector REST API endpoints](https://docs.splunk.com/Documentation/Splunk/8.1.2/Data/HECRESTendpoints)
* [Splunk Endpoints reference list](https://docs.splunk.com/Documentation/Splunk/8.1.2/RESTREF/RESTlist)
* [Format events for HTTP Event Collector](https://docs.splunk.com/Documentation/Splunk/8.1.2/Data/FormateventsforHTTPEventCollector)
* []()
* []()
* []()
* []()